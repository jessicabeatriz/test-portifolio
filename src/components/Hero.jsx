...
const Hero = () => {
  return (
    ...
    dark:text-white'>
      ...
      xl:leading-[95px] max-w-5xl'> Lorem ipsum <span
      className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text
      text-transparent'>dolor</span> sit amet.</h1>

      <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/
      75 max-w-4/5 sm:max-w-lg pb-3'>Praesent sodales ipsum eu ipsum imperdiet lobortis. Fusce dictum urna nec justo
       bibendum, eu lobortis purus mattis.</p>

       <div className='relative'>
        <img src={assets.hero_img} alt='' className='w-full max-w-6xl rounded-[45px]'/>
